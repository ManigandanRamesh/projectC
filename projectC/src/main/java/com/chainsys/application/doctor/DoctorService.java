...
//	@Bean
//	public void createrepo(DoctorRepository repo)
//
//	{
//		this.repo=repo;
//	}
	...
	// we need give from where to read from the HTTP request and also the content type("application/json")
	public String addDoctor(@RequestBody Doctor dr)
	{
	//	System.out.println("Doctor: "+dr.getId()+ " " +dr.getName());
		repo.save(dr);
		return "redirect:/getalldoctors";
	}
